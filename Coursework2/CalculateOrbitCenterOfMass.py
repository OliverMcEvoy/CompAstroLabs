...
def calculate_orbit_com(objects, initial_time_step=3600, max_steps=8766):
    ...
    # Compute the center of mass, note how only I needs to be passed in, quite proud of that one.
    ...
    for i in tqdm(range(max_steps - 1), desc="Calculating orbits", mininterval=1.0):
        ...
        for obj in objects:
            ...
            # I have tried to think of better ways of doing the is not None check for the first iteration. None I can think off do not introduce more errors/save processing
