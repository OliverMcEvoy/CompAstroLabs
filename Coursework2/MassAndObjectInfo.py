# I didnt intented to add this many exmaples when I started.
...
def get_masses_and_object_info(example="solar_system"):
    ...
    formatting = {
        ...
        "Pluto": {"linewidth": 1.5, "alpha": 0.75, "color": "indigo"},
    }
    ...
    if example == "solar_system":
    ...
    elif example == "jupiter_and_saturn":
        objects_info = [
            {"name": "Sun", "id": "10"},
            {"name": "Jupiter", "id": "599"},
            {"name": "Saturn", "id": "699"},
        ...
        formatting = {
            "Sun": {"linewidth": 1, "alpha": 1.0, "color": "yellow"},
            "Jupiter": {"linewidth": 1.5, "alpha": 0.75, "color": "red"},
            "Saturn": {"linewidth": 1.5, "alpha": 0.75, "color": "orange"},
        }
    elif example == "jupiter_and_saturn_no_sun":
        objects_info = [
            {"name": "Jupiter", "id": "599"},
            {"name": "Saturn", "id": "699"},
        ]
    ...
    elif example == "swap_jupiter_and_sun_mass":
        objects_info = [
            {"name": "Mercury", "id": "199"},
            {"name": "Sun", "id": "10"},
            {"name": "Moon", "id": "301"},
        ...
        formatting = {
            "Sun": {"linewidth": 1, "alpha": 1.0, "color": "blue"},
            "Sun_2": {"linewidth": 1, "alpha": 1, "color": "red"},
        }
    elif example == "pluto_is_sun":
        # Pluto is back woth a vengence
        objects_info = [
            {"name": "Mercury", "id": "199"},
            {"name": "Sun", "id": "10"},
            {"name": "Moon", "id": "301"},
    ...
    elif example == "hot_jupiters":
        # Everything is the mass of jupiter
        objects_info = [
            {"name": "Mercury", "id": "199"},
            {"name": "Sun", "id": "10"},
            {"name": "Halleys_Comet", "id": "90000001"},
    ...
    elif example == "solar_system_no_moon":
        objects_info = [
            {"name": "Mercury", "id": "199"},
            {"name": "Sun", "id": "10"},
            {"name": "Venus", "id": "299"},
